...
public class OcorrenciaController {
	...
	public OcorrenciaController(BuscaEntregaService buscaEntregaService, OcorrenciaAssembler ocorrenciaAssembler,
			OcorrenciaDisassembler ocorrenciaDisassembler, RegistroOcorrenciaService registroOcorrenciaService) {
		super();
	...
	public OcorrenciaModel create(@PathVariable Long entregaId, 
		...
		return ocorrenciaAssembler.toModel(registroOcorrenciaService.registrar(entregaId,ocorrenciaDisassembler.toDomainMedel(ocorrenciaInput).getDescricao()));
	}
